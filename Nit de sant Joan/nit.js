...
function mostarEstrelles() {
  ...
  let NovaEstrella = new Estrella(generarRandom(1, W), generarRandom(1, H), generarRandom(1, localStorage.getItem("radi")), "white","rgba(255, 255, 255,"+ Math.random()+ 0,1 +")",generarRandom(1,10));
  ...
  while (estrelles.length < localStorage.getItem("estrelles") && comptadorVoltes < 19000) {
    let comptador = 0;
    let estrellaComparar = new Estrella(generarRandom(7, window.innerWidth -22), generarRandom(7, innerHeight -50), generarRandom(1, localStorage.getItem("radi")), "white","rgba(255, 255, 255,"+ Math.random()+ 0,1 +")",generarRandom(1,10));
